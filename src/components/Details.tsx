  ...
  function printBlog() {
    return (
      <div className="row ml-0 mt-3">
        <div className="card border-0 mr-3" style={{ width: "25rem" }}>
          <img
          ...
          <div className="card-body">
            ...
            <p className="col-4 roundedCircleAbility mr-2">componetización</p>
          </div>
        </div>
        <div className="card border-0" style={{ width: "25rem" }}>
          ...
          <div className="card-body">
            ...
            <div className="row">
              <p className="col-3 roundedCircleAbility mr-2">actualidad</p>
              <p className="col-3 roundedCircleAbility mr-2">react</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div className="container">
      <div className="row">
        ...
        <div className="col mt-5">
          <h1 className="firsName text-capitalize">
            {PERSON["Nombre"].toLowerCase()}
          </h1>
          <h1 className="firsName font-weight-bold text-capitalize">
            {PERSON["Apellidos"].split(" ")[0].toLowerCase()}
          </h1>
          ...
          <div className="row mt-4">{printabilities()}</div>

          <p className="normalText mt-5">{PERSON["Sobre mí"]}</p>
        </div>
      </div>
      <div className="backGruoundImgDetails" style={{ marginTop: "20rem" }} />
      <h1 className="title2" style={{ marginTop: "20rem" }}>
        Miembros de{" "}
        <span className="text-capitalize">
          {abilityToSearch === "" ? "Sin concretar" : abilityToSearch}
        </span>
      </h1>
      <div className="row mt-3">{printPersonsSameAbilities()}</div>

      <h1 className="title2">Contamos en el blog</h1>
      ...
      <div className="row mt-5">
        <div className="backGruoundImgDetails " />
        {printTeamates()}
      </div>
    </div>
  );
